        ...
        {!modalRefining ? (
          <div className="refine-section">
            ...
            <div className="refine-chips">
              {["Add packing list & before-you-go essentials","How to maximize points & miles for this trip","Make it more budget-friendly","Add more local/hidden gems","Make the pace more relaxed","Add a day trip option"].map(s => (
